...
Congratulations on creating a new Stripes UI app module!  Follow the instructions below to run ui-report-module and start your development.
...
Run the following from the ui-report-module directory to serve your new app using a development server:
```
stripes serve
```
